(function () {
    ...
    function renderTable() {
        ...
        data.records.forEach(r => {
            ...
            tr.innerHTML = `
                <td data-label="Auswahl"><input type="checkbox" class="row-cb" data-pk="${esc(r.partitionKey)}" data-rk="${esc(r.rowKey)}"></td>
                ...
                ${photoCell}
                <td data-label="Latitude">${r.latitude.toFixed(6)}</td>
                <td data-label="Longitude">${r.longitude.toFixed(6)}</td>
